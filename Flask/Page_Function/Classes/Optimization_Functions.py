...
class GAOptimization:
    def __init__(self, prices, durations, total_cost_per_clinic, total_working_hours_per_month, profits, cogs, treatment_counts=None, use_bias=False, cogs_limit=None, patient_limit=None, bias_weight=0.25):
        self.prices = prices
        ...
        self.cogs = cogs
        self.treatment_counts = treatment_counts
    ...
    def initialize_individual(self):
        ...
        if self.use_bias and self.patient_limit:
            max_treatment_count = max(self.treatment_counts.values())
            normalized_counts = [self.treatment_counts.get(treatment_name, 0) / max_treatment_count for treatment_name in self.treatment_counts]
